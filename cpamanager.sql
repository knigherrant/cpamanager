...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2017 at 11:38 AM
...
--
-- Table structure for table `cpa_assets`
--

CREATE TABLE `cpa_assets` (
...
--
-- Dumping data for table `cpa_assets`
--
...
--
-- Table structure for table `cpa_associations`
--

CREATE TABLE `cpa_associations` (
...
--
-- Table structure for table `cpa_banners`
--

CREATE TABLE `cpa_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `cpa_banner_clients`
--

CREATE TABLE `cpa_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `cpa_banner_tracks`
--

CREATE TABLE `cpa_banner_tracks` (
...
--
-- Table structure for table `cpa_categories`
--

CREATE TABLE `cpa_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cpa_categories`
--

INSERT INTO `cpa_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 911, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 911, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 911, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 911, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 911, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 911, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_contact_details`
--

CREATE TABLE `cpa_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `cpa_content`
--

CREATE TABLE `cpa_content` (
...
--
-- Table structure for table `cpa_contentitem_tag_map`
--

CREATE TABLE `cpa_contentitem_tag_map` (
...
--
-- Table structure for table `cpa_content_frontpage`
--

CREATE TABLE `cpa_content_frontpage` (
...
--
-- Table structure for table `cpa_content_rating`
--

CREATE TABLE `cpa_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cpa_content_types`
--

CREATE TABLE `cpa_content_types` (
...
--
-- Dumping data for table `cpa_content_types`
--

INSERT INTO `cpa_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `cpa_core_log_searches`
--

CREATE TABLE `cpa_core_log_searches` (
...
--
-- Table structure for table `cpa_cpamanager_cpas`
--

CREATE TABLE `cpa_cpamanager_cpas` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `cpa_cpamanager_cpas`
--

INSERT INTO `cpa_cpamanager_cpas` (`id`, `asset_id`, `ordering`, `userid`, `company`, `firstname`, `midname`, `lastname`, `address1`, `address2`, `city`, `zip`, `phone`, `cell_phone`, `fax`, `email`, `url`, `logo`, `serverip`, `dbname`, `dbuser`, `dbpass`, `banner`, `notes`, `created`, `account`, `featured`, `location_id`) VALUES
(1, 57, 1, 911, '43423', '343242', '423423', '43243', '4324', '4324', '2432', '432423423', '432', '432423', '432432423', '423432', '43432', 'images/cpamanager/1489249459_anh-nen-canh-dong-hoa-huong-duong.jpg', '43423', '312', '312', '24342', 'images/cpamanager/1489249444_1471514129602_3899.jpg', '4324', '0000-00-00 00:00:00', 0, 0, 3);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_cpamanager_customers`
--

CREATE TABLE `cpa_cpamanager_customers` (
  `id` int(11) UNSIGNED NOT NULL,
  `userid` int(11) NOT NULL,
...
--
-- Table structure for table `cpa_cpamanager_invoices`
--

CREATE TABLE `cpa_cpamanager_invoices` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_cpamanager_links`
--
...
--
-- Table structure for table `cpa_extensions`
--

CREATE TABLE `cpa_extensions` (
...
--
-- Dumping data for table `cpa_extensions`
--

INSERT INTO `cpa_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"c51d89da348a0ab9ad5e6193554b6438"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1489649334}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'com_cpamanager', 'component', 'com_cpamanager', '', 1, 1, 0, 0, '{"name":"com_cpamanager","type":"component","creationDate":"May 2016","author":"Freddy Flores","copyright":"Copyright (C) 2016 METIK Marketing, LLC. All rights reserved.","authorEmail":"fflores@metikmarketing.com","authorUrl":"https:\\/\\/www.metikmarketing.com","version":"1.0.0","description":"View and control the CPAManager Application Manager","group":"","filename":"cpamanager"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_finder_filters`
--

CREATE TABLE `cpa_finder_filters` (
...
--
-- Table structure for table `cpa_finder_links`
--

CREATE TABLE `cpa_finder_links` (
...
--
-- Table structure for table `cpa_finder_links_terms0`
--

CREATE TABLE `cpa_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_finder_links_terms1`
--

CREATE TABLE `cpa_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms2`
--

CREATE TABLE `cpa_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms3`
--

CREATE TABLE `cpa_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms4`
--

CREATE TABLE `cpa_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms5`
--

CREATE TABLE `cpa_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms6`
--

CREATE TABLE `cpa_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms7`
--

CREATE TABLE `cpa_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms8`
--

CREATE TABLE `cpa_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_terms9`
--

CREATE TABLE `cpa_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_termsa`
--

CREATE TABLE `cpa_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_termsb`
--

CREATE TABLE `cpa_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_termsc`
--

CREATE TABLE `cpa_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_termsd`
--

CREATE TABLE `cpa_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_termse`
--

CREATE TABLE `cpa_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_links_termsf`
--

CREATE TABLE `cpa_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `cpa_finder_taxonomy`
--

CREATE TABLE `cpa_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cpa_finder_taxonomy`
--

INSERT INTO `cpa_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_finder_taxonomy_map`
--

CREATE TABLE `cpa_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_finder_terms`
--

CREATE TABLE `cpa_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_finder_terms_common`
--

CREATE TABLE `cpa_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cpa_finder_terms_common`
--

INSERT INTO `cpa_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `cpa_finder_tokens`
--

CREATE TABLE `cpa_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cpa_finder_tokens_aggregate`
--

CREATE TABLE `cpa_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_finder_types`
--

CREATE TABLE `cpa_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_languages`
--

CREATE TABLE `cpa_languages` (
...
--
-- Dumping data for table `cpa_languages`
--

INSERT INTO `cpa_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_menu`
--

CREATE TABLE `cpa_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cpa_menu`
--

INSERT INTO `cpa_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_CPAMANAGER', 'com-cpamanager', '', 'com-cpamanager', 'index.php?option=com_cpamanager', 'component', 0, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 43, 64, 0, '', 1),
(103, 'main', 'COM_CPAMANAGER_TITLE_CPAS', 'com-cpamanager-title-cpas', '', 'com-cpamanager/com-cpamanager-title-cpas', 'index.php?option=com_cpamanager&view=cpas', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 44, 45, 0, '', 1),
(104, 'main', 'COM_CPAMANAGER_TITLE_CUSTOMERS', 'com-cpamanager-title-customers', '', 'com-cpamanager/com-cpamanager-title-customers', 'index.php?option=com_cpamanager&view=customers', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 46, 47, 0, '', 1),
(105, 'main', 'COM_CPAMANAGER_TITLE_INVOICES', 'com-cpamanager-title-invoices', '', 'com-cpamanager/com-cpamanager-title-invoices', 'index.php?option=com_cpamanager&view=invoices', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 48, 49, 0, '', 1),
(106, 'main', 'COM_CPAMANAGER_TITLE_EXPENSES', 'com-cpamanager-title-expenses', '', 'com-cpamanager/com-cpamanager-title-expenses', 'index.php?option=com_cpamanager&view=expenses', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 50, 51, 0, '', 1),
(107, 'main', 'COM_CPAMANAGER_TITLE_RECEIPTS', 'com-cpamanager-title-receipts', '', 'com-cpamanager/com-cpamanager-title-receipts', 'index.php?option=com_cpamanager&view=receipts', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 52, 53, 0, '', 1),
(108, 'main', 'COM_CPAMANAGER_TITLE_MILEAGES', 'com-cpamanager-title-mileages', '', 'com-cpamanager/com-cpamanager-title-mileages', 'index.php?option=com_cpamanager&view=mileages', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 54, 55, 0, '', 1),
(109, 'main', 'COM_CPAMANAGER_TITLE_TAXRETURNS', 'com-cpamanager-title-taxreturns', '', 'com-cpamanager/com-cpamanager-title-taxreturns', 'index.php?option=com_cpamanager&view=taxreturns', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 56, 57, 0, '', 1),
(110, 'main', 'COM_CPAMANAGER_TITLE_LINKS', 'com-cpamanager-title-links', '', 'com-cpamanager/com-cpamanager-title-links', 'index.php?option=com_cpamanager&view=links', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 58, 59, 0, '', 1),
(111, 'main', 'COM_CPAMANAGER_TITLE_CONFIG', 'com-cpamanager-title-config', '', 'com-cpamanager/com-cpamanager-title-config', 'index.php?option=com_cpamanager&view=configs', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 60, 61, 0, '', 1),
(112, 'main', 'COM_CPAMANAGER_TITLE_REPORTS', 'com-cpamanager-title-reports', '', 'com-cpamanager/com-cpamanager-title-reports', 'index.php?option=com_cpamanager&view=reports', 'component', 0, 102, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 62, 63, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_menu_types`
--

CREATE TABLE `cpa_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `cpa_menu_types`
--

INSERT INTO `cpa_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `cpa_messages`
--

CREATE TABLE `cpa_messages` (
...
--
-- Table structure for table `cpa_messages_cfg`
--

CREATE TABLE `cpa_messages_cfg` (
...
--
-- Table structure for table `cpa_modules`
--

CREATE TABLE `cpa_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `cpa_modules`
--

INSERT INTO `cpa_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(17, 51, 'Breadcrumbs', '', '', 1, 'position-2', 911, '2017-03-06 15:16:32', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"moduleclass_sfx":"","showHome":"1","homeText":"","showComponent":"1","separator":"","cache":"0","cache_time":"0","cachemode":"itemid"}', 0, '*'),
...
--
-- Table structure for table `cpa_modules_menu`
--

CREATE TABLE `cpa_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `cpa_modules_menu`
--

INSERT INTO `cpa_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `cpa_newsfeeds`
--

CREATE TABLE `cpa_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_overrider`
--

CREATE TABLE `cpa_overrider` (
...
--
-- Table structure for table `cpa_postinstall_messages`
--

CREATE TABLE `cpa_postinstall_messages` (
...
--
-- Dumping data for table `cpa_postinstall_messages`
--

INSERT INTO `cpa_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `cpa_redirect_links`
--

CREATE TABLE `cpa_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_schemas`
--

CREATE TABLE `cpa_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `cpa_schemas`
--

INSERT INTO `cpa_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `cpa_session`
--

CREATE TABLE `cpa_session` (
...
--
-- Dumping data for table `cpa_session`
--

INSERT INTO `cpa_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('87ricfnprl0m88vc1iemf9rul7', 1, 0, '1489659916', 'joomla|s:724:"";', 911, 'admin'),
('rqnmjddci2i3cjg9fdqsi390f1', 1, 0, '1489660521', 'joomla|s:1440:"";', 911, 'admin');

-- --------------------------------------------------------

--
-- Table structure for table `cpa_tags`
--

CREATE TABLE `cpa_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `cpa_tags`
--

INSERT INTO `cpa_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 911, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `cpa_template_styles`
--

CREATE TABLE `cpa_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `cpa_template_styles`
--

INSERT INTO `cpa_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `cpa_ucm_base`
--

CREATE TABLE `cpa_ucm_base` (
...
--
-- Table structure for table `cpa_ucm_content`
--

CREATE TABLE `cpa_ucm_content` (
...
--
-- Table structure for table `cpa_ucm_history`
--

CREATE TABLE `cpa_ucm_history` (
...
--
-- Table structure for table `cpa_updates`
--

CREATE TABLE `cpa_updates` (
...
--
-- Table structure for table `cpa_update_sites`
--

CREATE TABLE `cpa_update_sites` (
...
--
-- Dumping data for table `cpa_update_sites`
--

INSERT INTO `cpa_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1489649378, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1489649378, ''),
...
--
-- Table structure for table `cpa_update_sites_extensions`
--

CREATE TABLE `cpa_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Dumping data for table `cpa_update_sites_extensions`
--

INSERT INTO `cpa_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28);
...
--
-- Table structure for table `cpa_usergroups`
--

CREATE TABLE `cpa_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `cpa_usergroups`
--

INSERT INTO `cpa_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `cpa_users`
--
...
--
-- Dumping data for table `cpa_users`
--
...
(911, 'Super User', 'admin', 'knigherrant@gmail.com', '$2y$10$R/URjqaGUPSNaZJSnzt21e2KAYTwmWVMopeGYXgvB2iB9EKPnBboG', 0, 1, '2017-03-03 07:31:25', '2017-03-16 10:11:09', '0', '', '0000-00-00 00:00:00', 0, '', '', 0),
...
--
-- Table structure for table `cpa_user_keys`
--

CREATE TABLE `cpa_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `cpa_user_notes`
--

CREATE TABLE `cpa_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `cpa_user_profiles`
--

CREATE TABLE `cpa_user_profiles` (
...
--
-- Table structure for table `cpa_user_usergroup_map`
--

CREATE TABLE `cpa_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `cpa_user_usergroup_map`
--
...
--
-- Table structure for table `cpa_utf8_conversion`
--

CREATE TABLE `cpa_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `cpa_utf8_conversion`
--

INSERT INTO `cpa_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `cpa_viewlevels`
--

CREATE TABLE `cpa_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `cpa_viewlevels`
--

INSERT INTO `cpa_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `cpa_associations`
--
ALTER TABLE `cpa_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indexes for table `cpa_banners`
--
ALTER TABLE `cpa_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_banner_clients`
--
ALTER TABLE `cpa_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indexes for table `cpa_banner_tracks`
--
ALTER TABLE `cpa_banner_tracks`
...
--
-- Indexes for table `cpa_categories`
--
ALTER TABLE `cpa_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_contact_details`
--
ALTER TABLE `cpa_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indexes for table `cpa_contentitem_tag_map`
--
ALTER TABLE `cpa_contentitem_tag_map`
...
--
-- Indexes for table `cpa_content_frontpage`
--
ALTER TABLE `cpa_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `cpa_content_rating`
--
ALTER TABLE `cpa_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `cpa_content_types`
--
...
--
-- Indexes for table `cpa_cpamanager_cpas`
--
ALTER TABLE `cpa_cpamanager_cpas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cpa_cpamanager_customers`
--
...
--
-- Indexes for table `cpa_cpamanager_invoices`
--
ALTER TABLE `cpa_cpamanager_invoices`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cpa_cpamanager_links`
--
...
--
-- Indexes for table `cpa_extensions`
--
ALTER TABLE `cpa_extensions`
...
--
-- Indexes for table `cpa_finder_filters`
--
ALTER TABLE `cpa_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `cpa_finder_links`
--
ALTER TABLE `cpa_finder_links`
...
--
-- Indexes for table `cpa_finder_links_terms0`
--
ALTER TABLE `cpa_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms1`
--
ALTER TABLE `cpa_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms2`
--
ALTER TABLE `cpa_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms3`
--
ALTER TABLE `cpa_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms4`
--
ALTER TABLE `cpa_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms5`
--
ALTER TABLE `cpa_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms6`
--
ALTER TABLE `cpa_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms7`
--
ALTER TABLE `cpa_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms8`
--
ALTER TABLE `cpa_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_terms9`
--
ALTER TABLE `cpa_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_termsa`
--
ALTER TABLE `cpa_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_termsb`
--
ALTER TABLE `cpa_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_termsc`
--
ALTER TABLE `cpa_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_termsd`
--
ALTER TABLE `cpa_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_termse`
--
ALTER TABLE `cpa_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_links_termsf`
--
ALTER TABLE `cpa_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `cpa_finder_taxonomy`
--
ALTER TABLE `cpa_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_finder_taxonomy_map`
--
ALTER TABLE `cpa_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `cpa_finder_terms`
--
ALTER TABLE `cpa_finder_terms`
...
--
-- Indexes for table `cpa_finder_terms_common`
--
ALTER TABLE `cpa_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `cpa_finder_tokens`
--
ALTER TABLE `cpa_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indexes for table `cpa_finder_tokens_aggregate`
--
ALTER TABLE `cpa_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `cpa_finder_types`
--
ALTER TABLE `cpa_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `cpa_languages`
--
ALTER TABLE `cpa_languages`
...
--
-- Indexes for table `cpa_menu`
--
ALTER TABLE `cpa_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_menu_types`
--
ALTER TABLE `cpa_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `cpa_messages`
--
ALTER TABLE `cpa_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `cpa_messages_cfg`
--
ALTER TABLE `cpa_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `cpa_modules`
--
ALTER TABLE `cpa_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_modules_menu`
--
ALTER TABLE `cpa_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `cpa_newsfeeds`
--
ALTER TABLE `cpa_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indexes for table `cpa_overrider`
--
ALTER TABLE `cpa_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cpa_postinstall_messages`
--
ALTER TABLE `cpa_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `cpa_redirect_links`
--
ALTER TABLE `cpa_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `cpa_schemas`
--
ALTER TABLE `cpa_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `cpa_session`
--
ALTER TABLE `cpa_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Indexes for table `cpa_tags`
--
ALTER TABLE `cpa_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_template_styles`
--
ALTER TABLE `cpa_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Indexes for table `cpa_ucm_base`
--
ALTER TABLE `cpa_ucm_base`
...
--
-- Indexes for table `cpa_ucm_content`
--
ALTER TABLE `cpa_ucm_content`
...
--
-- Indexes for table `cpa_ucm_history`
--
...
--
-- Indexes for table `cpa_updates`
--
ALTER TABLE `cpa_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `cpa_update_sites`
--
ALTER TABLE `cpa_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `cpa_update_sites_extensions`
--
ALTER TABLE `cpa_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `cpa_usergroups`
--
ALTER TABLE `cpa_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_user_keys`
--
ALTER TABLE `cpa_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `cpa_user_notes`
--
ALTER TABLE `cpa_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `cpa_user_profiles`
--
ALTER TABLE `cpa_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `cpa_user_usergroup_map`
--
ALTER TABLE `cpa_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `cpa_viewlevels`
--
ALTER TABLE `cpa_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `cpa_banner_clients`
--
ALTER TABLE `cpa_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_categories`
--
ALTER TABLE `cpa_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `cpa_contact_details`
--
ALTER TABLE `cpa_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `cpa_cpamanager_cpas`
--
ALTER TABLE `cpa_cpamanager_cpas`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `cpa_finder_filters`
--
ALTER TABLE `cpa_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_finder_links`
--
ALTER TABLE `cpa_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_finder_taxonomy`
--
ALTER TABLE `cpa_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `cpa_finder_terms`
--
ALTER TABLE `cpa_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_finder_types`
--
ALTER TABLE `cpa_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_languages`
--
ALTER TABLE `cpa_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `cpa_menu`
--
ALTER TABLE `cpa_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
--
-- AUTO_INCREMENT for table `cpa_menu_types`
--
ALTER TABLE `cpa_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `cpa_messages`
--
ALTER TABLE `cpa_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_modules`
--
ALTER TABLE `cpa_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `cpa_newsfeeds`
--
ALTER TABLE `cpa_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_overrider`
--
ALTER TABLE `cpa_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `cpa_postinstall_messages`
--
ALTER TABLE `cpa_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `cpa_redirect_links`
--
ALTER TABLE `cpa_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_tags`
--
ALTER TABLE `cpa_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `cpa_template_styles`
--
ALTER TABLE `cpa_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `cpa_ucm_content`
--
ALTER TABLE `cpa_ucm_content`
...
--
-- AUTO_INCREMENT for table `cpa_update_sites`
--
ALTER TABLE `cpa_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `cpa_usergroups`
--
ALTER TABLE `cpa_usergroups`
...
ALTER TABLE `cpa_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_user_notes`
--
ALTER TABLE `cpa_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cpa_viewlevels`
--
ALTER TABLE `cpa_viewlevels`
