 ...
 */
class CPAManagerControllerFiles extends JControllerAdmin
{
    ...
    public function getModel($name = 'file', $prefix = 'CPAManagerModel', $config = array('ignore_request' => true))
    {
    ...
    public function upload(){
        if(isset($_FILES['file'])){
            ...
            if($check === true){
                ...
                if(!is_dir($absolutePath)) exit(json_encode(array('rs'=>false, 'msg'=>JText::_('COM_METIKACCMGR_MSG_FOLDER_NOT_EXIST'))));
                if(is_file($absolutePath.$fileName)){
                    exit(json_encode(array('rs'=>false, 'msg'=>JText::_('COM_METIKACCMGR_MSG_FILE_EXISTED'))));
                }
