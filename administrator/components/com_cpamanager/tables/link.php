 ...
 * @since  1.6
 */
class CPAManagerTablelink extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__cpamanager_links', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_cpamanager.links.' . $array['id']))
		{
			$actions         = JAccess::getActions('com_cpamanager', 'links');
			$default_actions = JAccess::getAssetRules('com_cpamanager.links.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_cpamanager.links.' . (int) $this->$k;
	}
