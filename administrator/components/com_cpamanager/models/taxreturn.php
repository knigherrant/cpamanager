 ...
 * CPAManager model.
 */
class CPAManagerModelTaxreturn extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'taxreturn', $prefix = 'CPAManagerTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_cpamanager.taxreturn', 'taxreturn', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_cpamanager.edit.taxreturn.data', array());
