...
<form action="<?php echo JRoute::_('index.php?option=com_cpamanager&view=expenses'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <tbody>
            ...
            foreach ($this->items as $i => $item) :
                ...
                <tr class="row<?php echo $i % 2; ?>">
					...
					<?php endif; ?>
					<?php if ($canEdit): ?>
						<a href="<?php echo JRoute::_('index.php?option=com_cpamanager&task=expense.edit&id=' . (int) $item->id); ?>">
