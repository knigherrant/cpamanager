 ...
 */
class CPAManagerControllerRequest extends JControllerForm
{
    ...
    function saveComment(){
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_cpamanager&view=request&layout=view&id='.$input->getInt('item_id').'&Itemid='.$input->getInt('Itemid')), $msg);
        return;
    }
